...
export default ({ language }) => {
  ...
  return (
    <div className="leftPart text-center">
      <img src={require('../static/img/Álvaro Fernández García.png')} className="profileImg" alt={NOMBRE} />
      <h1 hidden>{NOMBRE}</h1>
      ...
      <ul className='profile-list'>
        ...
        <li className='padding-top-20'>
          <Icon src={require('../static/img/linkedin.svg')} link="https://www.linkedin.com/in/alvarofg95" />
        </li>
      </ul>
    </div>
  )
